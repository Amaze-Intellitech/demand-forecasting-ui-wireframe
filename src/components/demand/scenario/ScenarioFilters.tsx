...
import { ScenarioFilterOptions } from '../../../types/domain/scenarioDecisionTwin';
...
export const ScenarioFilters: React.FC<ScenarioFiltersProps> = ({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5">
      ...
      {/* Create Scenario Action Button */}
      <button
        type="button"
        onClick={onCreateScenario}
        className="flex items-center gap-1.5 bg-[#0284c7] hover:bg-[#0369a1] text-white text-xs font-bold px-4 py-2 rounded-lg shadow-xs hover:shadow-md transition-all active:scale-[0.98] cursor-pointer"
      >
